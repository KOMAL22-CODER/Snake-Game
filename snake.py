...
screen=Screen()
screen.setup(width=1240,height=700)
...
while(not gameover):
    ...
    if(snake.turtleobj[0].xcor()>620 or snake.turtleobj[0].ycor()>350 or snake.turtleobj[0].xcor()<-620 or snake.turtleobj[0].ycor()<-350):
        gameover=True
        score.gameover()
